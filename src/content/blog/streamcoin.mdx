---
title: Streamcoin
description: 'Created: July 14, 2024 1:28 PM'
date: 2026-01-03
tags:
  - writeup
category: web
...
💡 JWT bypass jku
XSS store in svg file
HTTP request smuggling in haproxy 2.4.0

</Callout>

- Code có thể sdung gen ra jwt
...
- Giờ ý tưởng dùng request smuggle vào api/test-ui với quyền admin và ip: 127.0.0.1 từ đó thực hiện xss, fetch api đến couchdb port 5984 như RESTAPI để truy vấn lấy flag
- Final payload
